...
public class WhackAMoleScreen extends ClickableScreen implements Runnable{
	...
	/**
	 * This method is a placeholder until our "partner" finishes the design of Players. For the time being, it
	 * returns "null". This means our code won't work until our partner is done, BUT at least our code will compile.
	 * 
